...
const getAllBooksHandler = (request) => {
  ...
  if (request.query.reading) {
    filteredBooks = filteredBooks
      .filter((book) => book.reading == request.query.reading);
  }

  if (request.query.finished) {
    filteredBooks = filteredBooks
      .filter((book) => book.finished == request.query.finished);
  }

  const resBooks = filteredBooks.map(({ id, name, publisher }) => ({ id, name, publisher }));
